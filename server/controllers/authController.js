...
const register = async (req, res) => {
    ...
    const default_profile_pic='/default-profile-image.avif'
    ...
    try {
      ...
      const insertUser = await pool.query(  
        'INSERT INTO client (username, email, password, phone,profile_image) VALUES ($1, $2, $3, $4,$5) RETURNING *',
        [username, email, hashedPassword, phone,default_profile_pic]
      );
